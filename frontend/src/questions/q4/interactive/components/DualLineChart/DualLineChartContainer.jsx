...
import DualLineChartD3 from './DualLineChart-d3'

export default function DualLineChartContainer({ data, title, defaultDetail, layoutKey, isExpanded = false }) {
  ...
  useEffect(() => {
    ...
    d3ref.current = new DualLineChartD3(el)
